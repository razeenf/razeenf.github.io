...
const projects = [
  ...
  },
  {
    ...
    image: p2,
    description: 'A simple way to manage and backup local files to your Google Drive.',
  ...
  },
  {
    ...
    image: p3,
    description: 'An extension that blocks distracting sites during an active Pomodoro timer.',
...
const ProjectGrid = () => {
    ...
    <div>
      <h1 className="proj-header">
        <Fade cascade duration={100} triggerOnce="True">stuff i've worked on in the past.</Fade>
      </h1>
